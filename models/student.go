...
type Student struct {
	...
	ProgramDepartment            ProgramDepartment `gorm:"foreignkey:ProgramDepartmentID" json:"-"`
	SecondaryProgramDepartmentID uint              `gorm:"index" json:"secondary_program_department_id"`
	SecondaryProgramDepartment   ProgramDepartment `gorm:"foreignkey:SecondaryProgramDepartmentID" json:"-"`
